...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libsAltJs = __webpack_require__(167);
	
	var _libsAltJs2 = _interopRequireDefault(_libsAltJs);
	
	var _libsStorageJs = __webpack_require__(187);
	
	var _libsStorageJs2 = _interopRequireDefault(_libsStorageJs);
	
	var _libsPersistJs = __webpack_require__(188);
	
	var _libsPersistJs2 = _interopRequireDefault(_libsPersistJs);
	
	main();
	
	function main() {
		(0, _libsPersistJs2['default'])(_libsAltJs2['default'], _libsStorageJs2['default'], 'app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LanesJsx = __webpack_require__(162);
	
	var _LanesJsx2 = _interopRequireDefault(_LanesJsx);
	
	var _actionsLaneActions = __webpack_require__(185);
	
	var _actionsLaneActions2 = _interopRequireDefault(_actionsLaneActions);
	
	var _storesLaneStore = __webpack_require__(186);
	
	var _storesLaneStore2 = _interopRequireDefault(_storesLaneStore);
	
	var _decoratorsConnectJsx = __webpack_require__(164);
	
	var _decoratorsConnectJsx2 = _interopRequireDefault(_decoratorsConnectJsx);
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_LanesJsx2['default'], { items: lanes })
				);
			}
		}, {
			key: 'addLane',
			value: function addLane() {
				_actionsLaneActions2['default'].create({});
			}
		}]);
	
		var _App = App;
		App = (0, _decoratorsConnectJsx2['default'])(_storesLaneStore2['default'])(App) || App;
		return App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LaneJsx = __webpack_require__(163);
	...
	var Lanes = (function (_React$Component) {
		...
		_createClass(Lanes, [{
			...
			value: function renderLane(lane) {
				return _react2['default'].createElement(
					_LaneJsx2['default'],
					{ className: 'lane', key: 'lane' + lane.id },
					_react2['default'].createElement(_LaneJsx2['default'].Header, { id: lane.id, name: lane.name }),
					_react2['default'].createElement(_LaneJsx2['default'].Notes, { id: lane.id, items: lane.notes })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesNoteStoreJs = __webpack_require__(165);
	
	var _storesNoteStoreJs2 = _interopRequireDefault(_storesNoteStoreJs);
	
	var _actionsNoteActionsJs = __webpack_require__(180);
	
	var _actionsNoteActionsJs2 = _interopRequireDefault(_actionsNoteActionsJs);
	...
	var _actionsLaneActionsJs = __webpack_require__(185);
	
	var _actionsLaneActionsJs2 = _interopRequireDefault(_actionsLaneActionsJs);
	...
	Lane.Header = (function (_React$Component2) {
		...
		function LaneHeader(props) {
			_classCallCheck(this, _LaneHeader);
	
			_get(Object.getPrototypeOf(_LaneHeader.prototype), 'constructor', this).call(this, props);
			var id = props.id;
		...
		_createClass(LaneHeader, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'div',
					_extends({ className: 'lane-header' }, props),
					_react2['default'].createElement(_EditableJsx2['default'], { className: 'lane-name',
						value: name,
			...
			key: 'removeLane',
			value: function removeLane(id) {
				_actionsLaneActionsJs2['default']['delete'](id);
			}
		}, {
			key: 'editLane',
			value: function editLane(id, name) {
				_actionsLaneActionsJs2['default'].rename({ id: id, name: name });
			}
		}, {
			key: 'addNote',
			value: function addNote(laneId) {
				_actionsNoteActionsJs2['default'].create({ task: "New task" });
				_actionsLaneActionsJs2['default'].attach({ laneId: laneId });
			}
		}]);
	
		var _LaneHeader = LaneHeader;
		LaneHeader = (0, _decoratorsConnectJsx2['default'])(_storesNoteStoreJs2['default'])(LaneHeader) || LaneHeader;
		return LaneHeader;
	})(_react2['default'].Component);
	...
	Lane.Notes = (function (_React$Component3) {
		...
		function LaneNotes(props) {
			_classCallCheck(this, _LaneNotes);
	
			_get(Object.getPrototypeOf(_LaneNotes.prototype), 'constructor', this).call(this, props);
			var id = props.id;
		...
		_createClass(LaneNotes, [{
			key: 'render',
			value: function render() {
				var _props2 = this.props;
				var items = _props2.items;
	
				var props = _objectWithoutProperties(_props2, ['items']);
	
				return _react2['default'].createElement(_NotesJsx2['default'], { items: _storesNoteStoreJs2['default'].get(items),
			...
			value: function editNote(id, task) {
				_actionsNoteActionsJs2['default'].update({ id: id, task: task });
			}
		}, {
			key: 'removeNote',
			value: function removeNote(laneId, noteId) {
				_actionsLaneActionsJs2['default'].detach({ laneId: laneId, noteId: noteId });
				_actionsNoteActionsJs2['default']['delete'](noteId);
			}
		}, {
			key: 'dropNote',
			value: function dropNote(laneId, noteId, ev, placement) {
				ev.preventDefault();
				var source = JSON.parse(ev.dataTransfer.getData("text/json"));
				var target = { laneId: laneId, noteId: noteId };
				_actionsLaneActionsJs2['default'].drop({ source: source, target: target, placement: placement });
			}
		}, {
			key: 'dragNote',
			value: function dragNote(laneId, noteId, ev) {
				ev.dataTransfer.effectAllowed = 'move';
				ev.dataTransfer.setData("text/json", JSON.stringify({ laneId: laneId, noteId: noteId }));
			}
		}, {
			key: 'allowDrop',
		...
		var _LaneNotes = LaneNotes;
		LaneNotes = (0, _decoratorsConnectJsx2['default'])(_storesNoteStoreJs2['default'])(LaneNotes) || LaneNotes;
		return LaneNotes;
	})(_react2['default'].Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeUuid = __webpack_require__(166);
	
	var _nodeUuid2 = _interopRequireDefault(_nodeUuid);
	
	var _libsAlt = __webpack_require__(167);
	
	var _libsAlt2 = _interopRequireDefault(_libsAlt);
	
	var _actionsNoteActions = __webpack_require__(180);
	
	var _actionsNoteActions2 = _interopRequireDefault(_actionsNoteActions);
	
	var _libsFind = __webpack_require__(181);
	
	var _libsFind2 = _interopRequireDefault(_libsFind);
	...
	var NoteStore = (function () {
		...
		_createClass(NoteStore, [{
			...
			value: function update(_ref) {
				...
				var notes = this.notes;
				var idx = _libsFind2['default'].byId(notes, id);
				if (idx < 0) return;
				notes[idx].task = task;
			...
			value: function deletemany(ids) {
				var notes = this.notes;
				this.setState({ notes: notes.filter(function (n) {
			...
			value: function get(ids) {
				...
				return (ids || []).map(function (id) {
					return _libsFind2['default'].byId(notes, id);
				}).filter(function (idx) {
					return idx >= 0;
				}).map(function (idx) {
					return notes[idx];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsFunctions = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _libsAlt2['default'].generateActions('create', 'update', 'delete', 'deletemany', 'get');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteJsx = __webpack_require__(184);
	...
	var Notes = (function (_React$Component) {
		...
		_createClass(Notes, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'ul',
					_extends({ className: 'notes' }, this.props),
			...
			value: function renderNote(note) {
				return _react2['default'].createElement(
					_NoteJsx2['default'],
					_extends({ id: note.id, key: 'note' + note.id }, this.props),
	...
	var Editable = (function (_React$Component) {
		...
		_createClass(Editable, [{
			...
			value: function renderRemove() {
				return _react2["default"].createElement(
					"button",
					{ className: "remove", onClick: this.props.onRemove },
					"X"
				);
			}
		}, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Note = (function (_React$Component) {
		...
		_createClass(Note, [{
			...
			key: 'onDragStart',
			value: function onDragStart(noteId, ev) {
				this.props.dragNote(noteId, ev);
			}
		}, {
			key: 'onDrop',
			value: function onDrop(noteId, ev) {
				var target = _react2['default'].findDOMNode(this);
				var placement = target.offsetTop + target.offsetHeight / 2 > ev.clientY ? "before" : "after";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _libsAlt2['default'].generateActions('create', 'rename', 'delete', 'attach', 'detach', 'drop');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteStore = __webpack_require__(165);
	...
	var LaneStore = (function () {
		...
		_createClass(LaneStore, [{
			...
			value: function _delete(id) {
				var lanes = this.lanes;
				var targetId = this.findLaneIndex(id);
	
				if (targetId >= 0) {
					var lane = lanes[targetId];
					this.setState({ lanes: lanes.slice(0, targetId).concat(lanes.slice(targetId + 1)) });
					_actionsNoteActions2['default'].deletemany.defer(lane.notes);
				} else console.warn('Failed to delete lane ' + id + '.');
			}
		}, {
			key: 'rename',
			value: function rename(_ref) {
				var id = _ref.id;
				var name = _ref.name;
			...
			value: function attach(_ref2) {
				...
				var lanes = this.lanes;
				var targetId = this.findLaneIndex(laneId);
			...
			value: function detach(_ref3) {
				...
				if (removeIndex !== -1) {
					...
					this.setState({ lanes: lanes });
				} else console.warn('Failed to remove note ' + noteId + ' from lane ' + laneId);
			}
		}, {
			key: 'drop',
			value: function drop(_ref4) {
				...
				var srcLaneIndex = this.findLaneIndex(source.laneId);
				var trgLaneIndex = this.findLaneIndex(target.laneId);
				if (srcLaneIndex < 0 || trgLaneIndex < 0) return;
	
				var srcLane = this.lanes[srcLaneIndex];
				var trgLane = this.lanes[trgLaneIndex];
				var srcNoteIndex = srcLane.notes.indexOf(source.noteId);
				var trgNoteIndex = trgLane.notes.length == 0 ? 0 : trgLane.notes.indexOf(target.noteId);
			...
			key: 'insertAt',
			value: function insertAt(arr, index, item) {
				return arr.slice(0, index).concat(item).concat(arr.slice(index));
			}
		}, {
			key: 'findLaneIndex',
			value: function findLaneIndex(id) {
				return _libsFind2['default'].byId(this.lanes, id);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altUtilsMakeFinalStore = __webpack_require__(189);
